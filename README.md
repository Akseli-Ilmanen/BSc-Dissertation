...
One goal of this analysis is to find out which subjective experiences are similar across substances. Below (left) are the co-occurence graphs for a number of substances and classes and BERTopics interactive graphs (right). By clicking on the images below you can access high-resolution versions (left) and interactive graphs (right). I recommend using a desktop browser for the latter. For the images on the left, you can also see them side by side on this [page](https://raw.githubusercontent.com/Akseli-Ilmanen/BSc-Dissertation/12969ea7b7d52b5a7c0accb58716f46c06d898e9/Files/Co-ocurrence%20networks%20high%20resolution%20page%20optimised.svg). For the classification scheme of substances and classes see the [supplementary material](https://ars.els-cdn.com/content/image/1-s2.0-S105381001830535X-mmc1.pdf) of Martial et al., 2019[^6].
